...
import { Capacitor, CameraPhoto, CameraResultType, CameraSource, Plugins, FilesystemDirectory } from "@capacitor/core";
...
export class PhotoService {
  ...
  public async savePicture(cameraPhoto: CameraPhoto) {
    ...
    if (this.platform.is('hybrid')) {
      ...
      // Using webPath to display the image instead of base64 since it's already loaded into memory
      return {
        filepath:    fileName,
